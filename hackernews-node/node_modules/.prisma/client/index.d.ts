...
export namespace Prisma {
  ...
  */
  ...
  export type LinkGroupByArgs = {
    ...
    take?: number
    skip?: number
    count?: LinkCountAggregateInputType | true
    avg?: LinkAvgAggregateInputType
    sum?: LinkSumAggregateInputType
    min?: LinkMinAggregateInputType
    max?: LinkMaxAggregateInputType
  ...
  type GetLinkGroupByPayload<T extends LinkGroupByArgs> = Promise<Array<
    PickArray<LinkGroupByOutputType, T['by']> & {
      [P in ((keyof T) & (keyof LinkGroupByOutputType))]: GetScalarType<T[P], LinkGroupByOutputType[P]>
    }
  >>
